            ...
            <div id="myBillingArea">
                ...
                if(isset($_GET['track']))
                {
                    ...
                    if(mysqli_num_rows($orderQueryRes) > 0)
                    {
                        ...
                        ?>
                        <table style="width: 80mm; margin-bottom: 20px;">
                        <tbody>
                            <tr>
                                <td style="text-align: center;" colspan="2">
                                    <h4 style="font-size: 23px; line-height: 30px; margin:2px; padding: 0;">SAKURA MOBILE</h4>
                                    <p style="font-size: 16px; line-height: 24px; margin:2px; padding: 0;">No 92,Anuradhapura Road,<br>Thambuththegama</p>
                                    <p style="font-size: 16px; line-height: 24px; margin:2px; padding: 0;">Tel: 077 9999 261 | 077 5761 663</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                    ...
                    if($orderItemQueryRes)
                    {
                        if(mysqli_num_rows($orderItemQueryRes))
                        {
                            ...
                            <div class="table-responsive mb-3">
                                    <table style="width:80mm;" cellpadding="5">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border-bottom: 1px solid #ccc;"><?= $row['item_name']; ?></td>
